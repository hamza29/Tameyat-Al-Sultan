package com.glowingsoft.tameyatalsultan.Activities;
...
public class DeliveryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayList.add(new NewModel("DHA", "helo", "", "", "", "", "", ""));
        arrayList.add(new NewModel("GAjumata", "helo", "", "", "", "", "", ""));
        arrayList.add(new NewModel("GAjumata", "helo", "", "", "", "", "", ""));
        arrayList.add(new NewModel("GAjumata", "helo", "", "", "", "", "", ""));
        arrayList.add(new NewModel("GAjumata", "helo", "", "", "", "", "", ""));
        arrayList.add(new NewModel("GAjumata", "helo", "", "", "", "", "", ""));
        ...
        arrayList.add(new NewModel("GAjumata", "helo", "", "", "", "", "", ""));
        arrayList.add(new NewModel("GAjumata", "helo", "", "", "", "", "", ""));
        LinearLayoutManager lLayout = new LinearLayoutManager(DeliveryActivity.this);
